...
<div id="time" class="modal  fade"  role="dialog" aria-hidden="true" style='height: 400px;width:600px;'>
          ...
          <?php //echo $rowss['user_name'];
            extract($_POST);
                 if(isset($submit1))
                 {
                  ...
                  $id1= intval($id1);
                 $time= strtotime($time);
                    $sel=mysqli_query($conn,"update request set add_time='$time' where add_time=0 and user_id='".$id1."'");
                   echo "<script>
      ...
      <div class="modal-body">
       <div class="well">
            ...
            <form method="post">
              ...
              <input type="hidden" name="id1" value='' id="fetched-data1" />
      ...
      <br/>
                   ...
                   <input type="submit" name="submit1" class="btn btn-success btn-sm" value=
                   "Add time">
      </div>
    ...
    <div class="box box-info">
      ...
      <div class="modal-body">
            <form method="post">
              ...
              <input type="hidden" name="id1" value='' id="fetched-data" />
