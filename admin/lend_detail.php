...
//                            echo $id;
  ...
  //                           $rowsss1=mysqli_fetch_array($sel_reu);
                  ...
                  <?php if(mysqli_num_rows($sel_reu1)<1)
                              { ?>
                      <td><a href="accept_request.php?id=<?php echo $rowss['id'];?>"><span class="label label-success">request  accept</span></a>/<a href="cancle_request.php?id=<?php echo $rowss['id'];?>"><span class="label label-success">cancle request</span></a></td>
                      <?php }else{
?>
