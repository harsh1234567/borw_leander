  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-folder"></i> <span>user detail </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
   ...
   //  echo $_SESSION['id1'];
      ...
      // echo "<strong>hello ".$lend_name."</strong>";
         ...
         {  // echo $pan1."wer";
            ...
            $sel_equ="insert into  employ_detail_lean   values('','$id','$c_name','$position','$joined_date','$left_date','$current_salary','$self_employ')";
...
<div class="col-md-8">
<form method="POST"><h2>Employement  detail </h2>
...
<br/><div class="input-group">
  <span class="input-group-addon" id="basic-addon1">
   ...
   <input type='text' class="form-control" name="joined_date" placeholder="joined the company date">
   </div>
<br/>
  <div class="input-group">
...
<br/>
  ...
  <input type='submit' name='submit' value="add detail "  class="btn btn-success btn-sm">
